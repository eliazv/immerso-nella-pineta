...
const EventiPinarella = () => {
  ...
  return (
    <BlogPostLayout
      title="Eventi a Pinarella e Cervia: Calendario Estate 2026"
    ...
    >
      ...
      <div className="bg-slate-100 p-8 rounded-2xl my-8 not-prose">
        <h3 className="text-xl font-bold text-pine-900 mb-4">Altri articoli su Pinarella</h3>
        <ul className="space-y-2">
          <li><Link to="/blog/festival-aquilone-cervia" className="text-pine-600 hover:underline font-medium">→ Festival Internazionale dell'Aquilone a Cervia</Link></li>
          <li><Link to="/blog/pinarella-summer-festival" className="text-pine-600 hover:underline font-medium">→ Pinarella Summer Festival: musica e intrattenimento</Link></li>
          <li><Link to="/blog/cosa-fare-pinarella-cervia" className="text-pine-600 hover:underline font-medium">→ Cosa fare a Pinarella: guida completa attività</Link></li>
        </ul>
      </div>
    </BlogPostLayout>
  );
