          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-6">
                Prenota il nostro appartamento e avrai incluso un posto auto
                privato gratuito. Niente stress, niente spese extra per il
                parcheggio. Prenotazione diretta senza commissioni - contatta il
                proprietario!
              </p>
