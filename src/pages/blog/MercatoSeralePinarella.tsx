...
const MercatoSeralePinarella = () => {
  return (
    <BlogPostLayout
      ...
      heroImage="https://images.unsplash.com/photo-1543168256-418811576931?w=1200&q=80"
    ...
    >
      ...
      <div className="bg-slate-100 p-8 rounded-2xl my-8 not-prose">
        ...
        <ul className="space-y-2">
          <li><Link to="/blog/mercatino-artigianato-cervia" className="text-pine-600 hover:underline font-medium">→ Mercatino dell'artigianato di Cervia</Link></li>
          <li><Link to="/blog/migliori-ristoranti-pinarella-cervia" className="text-pine-600 hover:underline font-medium">→ I migliori ristoranti a Pinarella</Link></li>
